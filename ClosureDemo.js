 ...
 * (and all other variables and functions that the outer function has access
 * to). However, the outer function does not have access to the variables and
 * functions defined inside the inner function. This provides a sort of security
 * for the variables of the inner function. Also, since the inner function has
 * access to the scope of the outer function, the variables and functions
 * defined in the outer function will live longer than the outer function
 * itself, if the inner function manages to survive beyond the life of the
 * outer function.
 * 
...
var createPet = function(name) {
  ...
  // An object will be returned! Like a module.
  return {
